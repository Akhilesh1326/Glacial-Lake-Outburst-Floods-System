      ...
      <div className='bg-slate-900 text-white '>
        <div className='flex justify-between bg-slate-800 py-4 px-2'>
          ...
          <span>
            ...
            <span className='font-light text-xl mx-4'>LogIn</span>
          </span>
        </div>
        <div className='flex flex-col justify-center items-center '>
          ...
          <Link to="/select-sign-up"><button className='py-2 px-4 bg-slate-600 rounded-xl my-10 mx-10 mt-20'>Open</button></Link>
        </div>
      </div>
